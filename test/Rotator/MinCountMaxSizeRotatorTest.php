...
use RunOpenCode\Backup\Rotator\MinCountMaxSizeRotator;

class MinCountMaxSizeRotatorTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @test
     */
    public function rotateWithinSizeConstrain()
    {
        $rotator = new MinCountMaxSizeRotator(3, 350);
     ...
     * @test
     */
    public function rotateAndKeepMinimum()
    {
        $rotator = new MinCountMaxSizeRotator(3, 200);
